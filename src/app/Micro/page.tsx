...
const Micro: React.FC = () => {
  ...
  return (
  <div className='min-h-screen container bg-gradient-to-r from-red-400 via-slate-300 to-slate-200'>
    <div className="min-h-[50vh] p-3 flex flex-col justify-center items-center">
